 ...
 * @LastEditTime: 2024-09-22 02:41:38
 * @FilePath: /mbti-match/script/deploy.android.js
 * @Description:
 *
...
// 打包命令
const BUILD_CMD = 'echo "1234" | sudo -S npm run build:h5-android'

// 本地打包产物目录
const LOCAL_DIST_FOLDER = path.join(path.resolve(), './mbti_match_android')

// 服务器产物目录
const SERVER_DIST_FOLDER = '/opt/deploy/mbti_match_android'
