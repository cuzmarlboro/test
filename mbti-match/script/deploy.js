 ...
 * @LastEditTime: 2024-09-22 13:43:59
 * @FilePath: /mbti-match/script/deploy.js
 * @Description:
 *
...
// 打包命令
const BUILD_CMD = 'npm run build:h5-prod';

// 本地打包产物目录
const LOCAL_DIST_FOLDER = path.join(path.resolve(), './mbti_match');

// 服务器产物目录
const SERVER_DIST_FOLDER = '/opt/deploy/mbti_match';
